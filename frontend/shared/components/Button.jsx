...
const interactiveClasses = {
  primary: {
    ...
    red: "border-transparent bg-rose-600 text-white visited:text-white hover:bg-rose-500 hover:text-white focus:text-white active:text-white dark:bg-rose-300 dark:text-rose-950 dark:visited:text-rose-950 dark:hover:bg-rose-100 dark:hover:text-rose-950 dark:focus:text-rose-950 dark:active:text-rose-950",
  ...
  secondary: {
    standard: "border-slate-200/80 bg-white/80 text-slate-700 visited:text-slate-700 shadow-sm hover:border-slate-300/80 hover:bg-slate-50 hover:text-slate-700 focus:text-slate-700 active:text-slate-700 dark:border-slate-700/70 dark:bg-slate-900/60 dark:text-slate-100 dark:visited:text-slate-100 dark:hover:bg-slate-800/80 dark:hover:text-slate-100 dark:focus:text-slate-100 dark:active:text-slate-100",
    green: "border-emerald-200/60 bg-emerald-50/90 text-emerald-800 visited:text-emerald-800 shadow-sm hover:bg-emerald-100 hover:text-emerald-800 focus:text-emerald-800 active:text-emerald-800 dark:border-emerald-800/60 dark:bg-emerald-950/50 dark:text-emerald-300 dark:visited:text-emerald-300 dark:hover:bg-emerald-900/60 dark:hover:text-emerald-300 dark:focus:text-emerald-300 dark:active:text-emerald-300",
    red: "border-rose-200/60 bg-rose-50/90 text-rose-700 visited:text-rose-700 shadow-sm hover:bg-rose-100 hover:text-rose-700 focus:text-rose-700 active:text-rose-700 dark:border-rose-800/60 dark:bg-rose-950/50 dark:text-rose-300 dark:visited:text-rose-300 dark:hover:bg-rose-900/60 dark:hover:text-rose-300 dark:focus:text-rose-300 dark:active:text-rose-300",
    amber: "border-amber-200/70 bg-amber-50/90 text-amber-700 visited:text-amber-700 shadow-sm hover:bg-amber-100 hover:text-amber-700 focus:text-amber-700 active:text-amber-700 dark:border-amber-800/60 dark:bg-amber-950/50 dark:text-amber-300 dark:visited:text-amber-300 dark:hover:bg-amber-900/60 dark:hover:text-amber-300 dark:focus:text-amber-300 dark:active:text-amber-300",
  },
  subtle: {
